 ...
 */
@Service
public class ProductServiceImpl extends ExtServiceImpl<ProductMapper, Product> implements ProductService {
     ...
     */
    @Override
    public Page<Product> pageDataPop(ProductDTO productDTO) {
     ...
     */
    @Override
    public Rc pageData(ProductDTO productDTO) {
        QueryWrapper<Product> qw = new QueryWrapper<>();
        QwUtils.eq(qw, "dcode", productDTO.getDcode());
        QwUtils.eq(qw, "dname", productDTO.getDname());
        QwUtils.eq(qw, "model", productDTO.getModel());
        ...
        return this.pageOrList(productDTO.page(), qw);
    }
}
